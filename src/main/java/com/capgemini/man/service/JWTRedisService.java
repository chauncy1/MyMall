...
import com.capgemini.man.common.constant.RedisConstant;
import com.capgemini.man.entity.JWTInfoEntity;
import com.capgemini.man.util.JWTUtil;
...
public class JWTRedisService{
	...
	public JWTInfoEntity create(Long userId) {
		...
		return new JWTInfoEntity(userId, token);
	}
...
//			}
	...
	public JWTInfoEntity get(String token) throws Exception {
		Claims claims = JWTUtil.parseJWT(token);
		Integer userId = claims.get(JWTUtil.SUBJECT, Integer.class);
		return new JWTInfoEntity(userId.longValue() , token);
	}
